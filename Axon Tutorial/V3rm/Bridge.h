...
static int GarbageCollector(lua_State* L) { // Dude what this is deplicated?
...
namespace Bridge
{
	static int DownloadString(lua_State* L) { // Loadstring support?
	...
	static int GetObjects(lua_State* L) { // Getobjects.
	...
	int IndexYeet(lua_State* L) { // I think used for loadstring.
